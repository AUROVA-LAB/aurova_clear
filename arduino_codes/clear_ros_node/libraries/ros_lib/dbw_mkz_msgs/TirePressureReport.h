#ifndef _ROS_dbw_mkz_msgs_TirePressureReport_h
#define _ROS_dbw_mkz_msgs_TirePressureReport_h
...
namespace dbw_mkz_msgs
{
  ...
  class TirePressureReport : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dbw_mkz_msgs/TirePressureReport"; };
