#ifndef _ROS_dbw_mkz_msgs_ThrottleCmd_h
#define _ROS_dbw_mkz_msgs_ThrottleCmd_h
...
namespace dbw_mkz_msgs
{
  ...
  class ThrottleCmd : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "dbw_mkz_msgs/ThrottleCmd"; };
    const char * getMD5(){ return "d75259a1444adebea30e45b37542c415"; };
