#ifndef _ROS_iri_tracking_vehicles_BoundingBox_h
#define _ROS_iri_tracking_vehicles_BoundingBox_h
...
namespace iri_tracking_vehicles
{
  ...
  class BoundingBox : public ros::Msg
  {
    ...
    const char * getType(){ return "iri_tracking_vehicles/BoundingBox"; };
    const char * getMD5(){ return "8260e363a8734a51e9672881f8d6c95a"; };
